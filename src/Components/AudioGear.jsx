...
const AudioGear = () => {
  return (
    <div
      className="dp:h-[37rem] md:h-[38rem] xs:h-[43.1rem] xs:w-[90%] dp:w-[80%]
    flex dp:flex-row xs:flex-col dp:justify-between  my-28
    "
    >
      <div className="overflow-hidden rounded-lg">
        <img className="xs:hidden dp:flex" src={phDesktop} alt="" />
        <img
          className="scale-[1.7] overflow-hidden md:flex  xs:hidden dp:hidden"
          src={phTablet}
          alt=""
        />
        <img src={phMobile} className='md:hidden  xs:flex' alt="" />
      </div>
