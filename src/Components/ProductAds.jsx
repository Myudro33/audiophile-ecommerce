    ...
    <div className="dp:w-[80%] my-16 xs:w-[90%] xs:h-[40rem] dp:h-[35rem] flex xs:flex-col xs:justify-between dp:flex-row dp:justify-between">
      {reverse === false && (
        <>
          ...
          <div className="dp:w-[48%] xs:h-[48%] md:px-16 dp:px-0 dp:h-full dp:pl-16 flex flex-col xs:items-center dp:items-start dp:justify-center">
            <h1 className="uppercase xs:text-3xl md:text-[40px] font-semibold">
              {filteredData.name}
            </h1>
      ...
      {reverse && (
        <>
          <div className="dp:w-[48%] xs:h-[48%] md:px-16 dp:px-0 dp:h-full dp:pl-16 xs:hidden dp:flex flex-col xs:items-center dp:items-start dp:justify-center">
            <h1 className="uppercase xs:text-3xl md:text-[40px] font-semibold">
              {filteredData.name}
            </h1>
            <p className="my-10 xs:text-center dp:text-start text-[#00000080]">
          ...
          <div className="dp:w-[48%] xs:h-[48%] md:px-16 dp:px-0 dp:h-full dp:pl-16 xs:flex dp:hidden flex-col xs:items-center dp:items-start dp:justify-center">
            <h1 className="uppercase xs:text-3xl md:text-[40px] font-semibold">
              {filteredData.name}
            </h1>
            <p className="my-10 xs:text-center dp:text-start text-[#00000080]">
